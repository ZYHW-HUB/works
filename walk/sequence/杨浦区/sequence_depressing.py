...
if __name__ == '__main__':
    ...
    model_path = "walk/deeplabv3-master/training_logs/siamese_depressing/saved_models/best_model.pth"  # 修改为实际路径
    ...
    # 保存结果
    save_scores_to_db(db_config, scores, split='depressing')
