...
sys.path.append("walk/deeplabv3-master/model")
from model.deeplabv3 import DeepLabV3

sys.path.append("walk/deeplabv3-master/utils")
...
if __name__ == "__main__":
    ...
    network = DeepLabV3(model_id, project_dir="walk/deeplabv3-master").cuda()

    train_dataset = DatasetTrain(cityscapes_data_path="walk",
                                cityscapes_meta_path="walk/meta")
    val_dataset = DatasetVal(cityscapes_data_path="walk",
                            cityscapes_meta_path="walk/meta")
    ...
    with open("walk/meta/class_weights.pkl", "rb") as file: # (needed for python3)
