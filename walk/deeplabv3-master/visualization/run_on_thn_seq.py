...
sys.path.append("walk/deeplabv3-master")
...
network = DeepLabV3("eval_seq_thn", project_dir="walk/deeplabv3-master").cuda()
network.load_state_dict(torch.load("walk/deeplabv3-master/pretrained_models/model_13_2_2_2_epoch_580.pth"))

val_dataset = DatasetThnSeq(thn_data_path="walk/deeplabv3-master/data/thn")
